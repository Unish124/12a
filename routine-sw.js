...
const CACHE_NAME = "routine-12a-v1";
...
//
// NOTE: this service worker is registered with scope "/routine.html" on
// the 12a.unish.info.np domain, so it will only ever intercept requests
// for that page.
